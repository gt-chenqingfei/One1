 ...
 * <p>&nbsp;</p>
 * To be used via {@link com.oneone.framework.ui.imagepicker.photoview.PhotoViewAttacher#setOnDoubleTapListener(GestureDetector.OnDoubleTapListener)}
 */
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        if (null != photoViewAttacher.getmClickListener()) {
            photoViewAttacher.getmClickListener().onClick(photoViewAttacher.getImageView());
        }
