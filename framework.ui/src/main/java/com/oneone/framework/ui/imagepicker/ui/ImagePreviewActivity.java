...
import com.oneone.framework.ui.imagepicker.util.NavigationBarChangeListener;
import com.oneone.framework.ui.imagepicker.util.Utils;
import com.oneone.framework.ui.imagepicker.view.SuperCheckBox;
...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCbOrigin.setText(getString(R.string.str_album_origin));
        ...
        mTitleCount.setText(getString(R.string.str_album_preview_image_count, mCurrentPosition + 1, mImageItems.size()));
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Toast.makeText(ImagePreviewActivity.this, getString(R.string.str_album_select_limit, selectLimit), Toast.LENGTH_SHORT).show();
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        ...
        if (mCbOrigin.isChecked()) {
            ...
            mCbOrigin.setText(getString(R.string.str_album_origin_size, fileSize));
        }
    }
    ...
    public void onImageSingleTap() {
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.imagepicker_top_out));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.imagepicker_fade_out));
...
//            if (Build.VERSION.SDK_INT >= 16) content.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
            ...
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.imagepicker_top_in));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.imagepicker_fade_in));
