package com.oneone.framework.ui.imagepicker.adapter;
...
import com.oneone.framework.ui.imagepicker.ui.ImageBaseActivity;
...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new CameraViewHolder(mInflater.inflate(R.layout.imagepicker_adapter_camera_item,parent,false));
        }
        return new ImageViewHolder(mInflater.inflate(R.layout.imagepicker_adapter_image_list_item,parent,false));
    }
            ...
            checkView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity.getApplicationContext(), mActivity.getString(R.string.str_album_select_limit, selectLimit), Toast.LENGTH_SHORT).show();
