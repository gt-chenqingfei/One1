 ...
 */
package com.oneone.framework.ui.widget.wheelview.common;
...
public class WheelConstants {
     ...
     * 平滑滚动持续时间
     */
    public static final int WHEEL_SMOOTH_SCROLL_DURATION = 0;
     ...
     * 滚轮item高度
     */
    public static final int WHEEL_ITEM_HEIGHT = 39;

    /**
     * 滚轮默认文本颜色
     */
    public static final int WHEEL_TEXT_COLOR = Color.parseColor("#7E94BB");
     ...
     * common皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_COMMON_COLOR = Color.parseColor("#6667FD");

    /**
     * common皮肤选中框divider颜色
     */
    public static final int WHEEL_SKIN_COMMON_DIVIDER_COLOR = Color.parseColor("#00000000");

    /**
     * common皮肤左右边框颜色
     */
    public static final int WHEEL_SKIN_COMMON_BORDER_COLOR = Color.parseColor("#00000000");
     ...
     * 滚轮滑动时展示选中项延迟时间
     */
    public static final int WHEEL_SCROLL_DELAY_DURATION =0;
