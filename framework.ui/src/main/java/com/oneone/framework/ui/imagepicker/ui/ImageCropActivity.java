...
import com.oneone.framework.ui.imagepicker.util.BitmapUtil;
import com.oneone.framework.ui.imagepicker.view.CropImageView;
...
public class ImageCropActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imagepicker_activity_image_crop);
        initToolbar();
...
//        mCropImageView.setImageURI(Uri.fromFile(new File(imagePath)));
        ...
        findViewById(R.id.ok_btn_text).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initToolbar() {
        mToolbar = (Toolbar) findViewById(R.id.toolbar_normal);
        //设置返回按键
        mToolbar.setNavigationIcon(getResources()
                .getDrawable(R.drawable.preview_icon_wo_cloes));
        //初始化设置为空
        mToolbar.setTitle("");
