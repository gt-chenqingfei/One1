package com.oneone.framework.ui.widget.tablayout;
...
import com.oneone.framework.ui.widget.tablayout.listener.OnTabSelectListener;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
     ...
     */
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, List<Fragment> fragments) {
        if (vp == null) {
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    class InnerPagerAdapter extends FragmentPagerAdapter {
        ...
        public InnerPagerAdapter(FragmentManager fm, List<Fragment> fragments, String[] titles) {
            super(fm);
