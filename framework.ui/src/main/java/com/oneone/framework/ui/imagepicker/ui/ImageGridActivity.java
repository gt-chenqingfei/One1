package com.oneone.framework.ui.imagepicker.ui;
...
import com.oneone.framework.ui.imagepicker.ImageDataSource;
import com.oneone.framework.ui.imagepicker.ImagePicker;
import com.oneone.framework.ui.imagepicker.adapter.ImageFolderAdapter;
import com.oneone.framework.ui.imagepicker.adapter.ImageRecyclerAdapter;
import com.oneone.framework.ui.imagepicker.bean.ImageFolder;
import com.oneone.framework.ui.imagepicker.bean.ImageItem;
import com.oneone.framework.ui.imagepicker.util.Utils;
import com.oneone.framework.ui.imagepicker.view.FolderPopUpWindow;
import com.oneone.framework.ui.imagepicker.view.GridSpacingItemDecoration;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imagepicker_activity_image_grid);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                showToast(getString(R.string.str_ablum_permission_denied));
            }
        } else if (requestCode == REQUEST_PERMISSION_CAMERA) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                imagePicker.takePicture(this, ImagePicker.REQUEST_CODE_TAKE);
            } else {
                showToast(getString(R.string.str_camera_permission_denied));
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if (mImageFolders == null) {
                Log.i("ImageGridActivity", "ImageFolders is null");
                return;
            }
            //点击文件夹按钮
...
//            mImageGridAdapter.refreshData(imageFolders.getObject(0).images);
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            mBtnOk.setText(getString(R.string.str_album_select_complete, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            mBtnOk.setEnabled(true);
            mBtnPre.setEnabled(true);
            mBtnPre.setText(getResources().getString(R.string.str_album_preview_count, imagePicker.getSelectImageCount()));
            ...
            mBtnOk.setText(getString(R.string.str_completed));
            mBtnOk.setEnabled(false);
            mBtnPre.setEnabled(false);
            mBtnPre.setText(getResources().getString(R.string.str_album_preview));
