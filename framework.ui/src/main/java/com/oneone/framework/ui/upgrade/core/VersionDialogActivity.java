package com.oneone.framework.ui.upgrade.core;
...
import com.oneone.framework.ui.upgrade.callback.APKDownloadListener;
import com.oneone.framework.ui.upgrade.callback.CommitClickListener;
import com.oneone.framework.ui.upgrade.callback.DialogDismissListener;
import com.oneone.framework.ui.upgrade.callback.DownloadListener;
...
import com.oneone.framework.ui.upgrade.v2.ui.AllenBaseActivity;
    ...
    public void showLoadingDialog(int currentProgress) {
        ...
        if (!isDestroy) {
            if (loadingDialog == null) {
                loadingView = LayoutInflater.from(this).inflate(R.layout.upgrade_downloading_layout, null);
