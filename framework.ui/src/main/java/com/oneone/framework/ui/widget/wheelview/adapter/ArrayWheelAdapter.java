 ...
 */
package com.oneone.framework.ui.widget.wheelview.adapter;
...
import com.oneone.framework.ui.widget.wheelview.widget.WheelItem;
 ...
 * @author venshine
 */
public class ArrayWheelAdapter extends BaseWheelAdapter<SheetItem> {
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        ...
        wheelItem.setText(item.getValue());
        return convertView;
    }
