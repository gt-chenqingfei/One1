...
/**
 * @author  https://github.com/jaychang0917/SimpleText
 */
public class SimpleText extends SpannableString {
  ...
  public static SimpleText from(Context context,CharSequence text) {
  ...
  public SimpleText allStartWith(String... prefixs) {
    ...
    for (String prefix : prefixs) {
      ...
      // List<Range> ranges = Utils.ranges(toString(), Pattern.quote(prefix) + ".*" + Pattern.quote(prefix));
      List<Range> ranges = Utils.ranges(toString(), "#[\\p{Print}\\p{InCJKUnifiedIdeographs}&&[^#]]+#");
