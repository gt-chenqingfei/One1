...
//            data = FileProvider.getUriForFile(ApplicationContext.getInstance(), authority, file);
        }
//        intent.setDataAndType(data, type);
    ...
    public static Intent getLaunchAppIntent(final String packageName) {
        return ApplicationContext.getInstance().getPackageManager().getLaunchIntentForPackage(packageName);
    }
