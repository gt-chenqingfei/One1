...
import com.oneone.modules.msg.widget.emoji.MyEmojiCommonUtils;
...
public class MyChatInputView  extends LinearLayout
    ...
    public static final String MENU_ITEM_EMOJI = "item_emoji";
    public static final String MENU_ITEM_CAREMA = "item_carema";
...
//    private LinearLayout mMenuItemContainer;
    ...
    public MyChatInputView(Context context) {
        super(context);
        init(context);
    }

    public MyChatInputView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyChatInputView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public void hideMenuItem (String itemName) {
        if (itemName.equals(MENU_ITEM_EMOJI)) {
            mEmojiBtn.setVisibility(View.GONE);
        } else if (itemName.equals(MENU_ITEM_CAREMA)) {
    ...
    private void init(Context context) {
        mContext = context;
        inflate(context, R.layout.view_my_chat_input, this);
...
//        View voiceBtnContainer = findViewById(cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_voice);
//        View photoBtnContainer = findViewById(cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_photo);
//        View cameraBtnContainer = findViewById(cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_camera);
//        View emojiBtnContainer = findViewById(cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_emoji);
...
//        emojiBtnContainer.setOnClickListener(onMenuItemClickListener);
        mCameraBtn.setOnClickListener(onMenuItemClickListener);
...
//        mSendCountTv = (TextView) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_menuitem_tv_send_count);
        mInputMarginLeft = (Space) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_input_margin_left);
        mInputMarginRight = (Space) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_input_margin_right);
        mChatInputContainer = (RelativeLayout) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_ll_input_container);
...
//        });
    ...
    EmoticonClickListener emoticonClickListener = new EmoticonClickListener() {
        ...
        public void onEmoticonClick(Object o, int actionType, boolean isDelBtn) {
            ...
            if (isDelBtn) {
                MyEmojiCommonUtils.delClick(mChatInput);
            } else {
                if (o == null) {
                    return;
                }
...
//                    }
                    ...
                    String content = null;
                    if (o instanceof IMEmoji) {
                        System.out.println("1111");
                        content = ((IMEmoji) o).getCode();
                        if (emojiClickListener != null)
                            emojiClickListener.onImEmojiClick((IMEmoji) o);
                    ...
                    System.out.println("EMOJI CLICK!!!!!!");
...
//                    editable.insert(index, content);
    ...
    public void setImEmojiClickListener (EmojiClickListener listener) {
...
//        mSelectAlbumIb.setVisibility(mStyle.getShowSelectAlbum() ? VISIBLE : INVISIBLE);
        ...
        MyEmojiCommonUtils.initEmoticonsEditText(mChatInput);
        mEmojiRl.setAdapter(MyEmojiCommonUtils.getCommonAdapter(mContext, emoticonClickListener));
    }
...
//                            cn.jiguang.imui.chatinput.R.drawable.aurora_menuitem_send));
//                    mSendCountTv.setVisibility(View.INVISIBLE);
                ...
                if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_voice) {
                ...
                } else if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_photo) {
                ...
                } else if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_menuitem_ib_camera) {
                    System.out.println("carema click!!!!!!!!");
                    if (mListener != null) {
...
//                        }
                ...
                } else if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_menuitem_ib_emoji) {
                    System.out.println("emoji click!!!!!!!!");
    ...
    private void playVoice() {
        try {
            ...
            Toast.makeText(getContext(), getContext().getString(cn.jiguang.imui.chatinput.R.string.file_not_found_toast),
                    Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        } finally {
            try {
...
//            mSendCountTv.setVisibility(View.INVISIBLE);
     ...
     */
    private void triggerSendButtonAnimation(final Button sendBtn, final boolean hasContent,
