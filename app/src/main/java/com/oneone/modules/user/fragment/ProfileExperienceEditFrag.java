 ...
 */
@Alias("特殊经历")
@LayoutResource(R.layout.frag_profile_experience_edit)
public class ProfileExperienceEditFrag extends
    ...
    @BindView(R.id.frag_profile_experience_afv)
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        UserRoleSettingTagBean tagBean;
        if (!isShow) {
            mPb.setVisibility(View.GONE);
            tagBean = HereUser.getInstance().getUserInfo().getExperienceTags();
        } else {
            tagBean = OpenRelationPresenter.getTempUserInfo().getExperienceTags();
        }
        ...
        mFlowLayout.setLimit(10)
                ...
                .setAddEditTextBackground(R.drawable.selector_step_8_tag_bg)
                .setAddEditTextTextColor(R.color.color_selector_step_8_text)
                .setMaxSelected(10).setAddBtnText(R.string.str_set_single_flow_page_custom_tag)
                .setAddBtnColor(R.color.single_flow_content_bg_8).setListener(this);
        EventBus.getDefault().register(this);
        mPresenter.getTags(StoryTag.EXPERIENCE, this);
    }
    ...
    public void onSelected(List<String> tags) {
        ...
        step6Params.addRule(RelativeLayout.ABOVE, R.id.step_8_top_tag_collection_inner_layout);
    ...
    public void onNextStepEvent(EventNextStep event) {
        ...
        userInfo.setExperienceTags(bean);
