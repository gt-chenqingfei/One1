...
public class ProfileCharacterEditFrag extends
    ...
    @BindView(R.id.frag_profile_character_afv)
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (!isShow) {
            ...
            tagBean = HereUser.getInstance().getUserInfo().getCharacterTags();
        } else {
            tagBean = OpenRelationPresenter.getTempUserInfo().getCharacterTags();
        }
        ...
        mFlowLayout.setLimit(10)
                ...
                .setAddEditTextBackground(R.drawable.selector_step_7_tag_bg)
                .setAddEditTextTextColor(R.color.color_selector_step_7_text)
                .setMaxSelected(10).setAddBtnText(R.string.str_set_single_flow_page_custom_tag)
                .setAddBtnColor(R.color.single_flow_content_bg_7).setListener(this);
        EventBus.getDefault().register(this);
        mPresenter.getTags(StoryTag.CHARACTER, this);
    }
    ...
    public void onSelected(List<String> tags) {
        RelativeLayout.LayoutParams step6Params =
                (RelativeLayout.LayoutParams) step7TvTag2.getLayoutParams();
        ...
        step6Params.addRule(RelativeLayout.ABOVE, R.id.step_7_top_tag_collection_inner_layout);
    ...
    public void onNextStepEvent(EventNextStep event) {
        ...
        if (selectedValue == null || selectedValue.size() < 3) {
            ToastUtil.show(getContext(), String.format(getString(R.string.str_set_single_flow_page_min_count_tags), 3 + ""));
            return;
        }
