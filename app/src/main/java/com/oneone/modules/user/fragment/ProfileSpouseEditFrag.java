 ...
 */
@Alias("择偶偏好")
@LayoutResource(R.layout.frag_profile_spouse_edit)
public class ProfileSpouseEditFrag extends
    ...
    @BindView(R.id.frag_profile_spouse_afv)
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (!isShow) {
            ...
            tagBean = HereUser.getInstance().getUserInfo().getSpousePrefsTags();
        } else {
            tagBean = OpenRelationPresenter.getTempUserInfo().getSpousePrefsTags();
        }
        ...
        mFlowLayout.setLimit(10)
                ...
                .setAddEditTextBackground(R.drawable.selector_step_10_tag_bg)
                .setAddEditTextTextColor(R.color.color_selector_step_10_text)
                .setMaxSelected(10)
                .setAddBtnText(R.string.str_set_single_flow_page_custom_tag)
                .setAddBtnColor(R.color.single_flow_content_bg_10).setListener(this);
        EventBus.getDefault().register(this);
        mPresenter.getTags(StoryTag.SPOUSE, this);
    }
    ...
    public void onSelected(List<String> tags) {
        ...
        step6Params.addRule(RelativeLayout.ABOVE, R.id.step_10_top_tag_collection_inner_layout);
    ...
    public void onNextStepEvent(EventNextStep event) {
        ...
        userInfo.setSpousePrefsTags(bean);
